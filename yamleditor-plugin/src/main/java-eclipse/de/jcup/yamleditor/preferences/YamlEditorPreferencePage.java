...
public class YamlEditorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        /* code folding */
        codeFoldingEnabledOnNewEditors = new BooleanFieldEditor(P_OPEN_NEW_EDITORS_WITH_CODE_FOLDING_ENABLED.getId(), "New opened editors have code folding enabled", otherComposite);
        ...
        /* - Margin ruler - */
        /* ---------------- */
        marginRuleColor = new ColorFieldEditor(P_EDITOR_MARGIN_RULE_LINE_COLOR.getId(), "Margin rule line color", otherComposite);
        ...
        autoCreateEndBrackets = new BooleanFieldEditor(P_EDITOR_AUTO_CREATE_END_BRACKETS.getId(), "Auto create ending brackets", bracketsGroup);
        ...
        codeAssistWithYamlKeywords = new BooleanFieldEditor(P_CODE_ASSIST_ADD_KEYWORDS.getId(), "Yaml keywords and external commands", codeAssistGroup);
        ...
        Group specialSupportGroup = new Group(appearanceComposite, SWT.NONE);
        specialSupportGroup.setText("Special");
        specialSupportGroup.setLayout(new GridLayout());
        specialSupportGroup.setLayoutData(codeAssistGroupLayoutData);
        BooleanFieldEditor goTemplateSupportEditor = new BooleanFieldEditor(P_GO_TEMPLATE_SUPPORT_ENABLED.getId(), "Support Go templates", specialSupportGroup);
