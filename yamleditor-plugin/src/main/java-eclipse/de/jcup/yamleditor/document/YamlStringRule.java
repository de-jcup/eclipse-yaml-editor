...
public class YamlStringRule extends PatternRule {

	private static final boolean BREAKS_ON_EOL = true;// only single lines supported in yaml
	private static final boolean BREAKS_ON_EOF = true;
	private static final boolean ESCAPE_CONTINUES_LINE = false;


	public YamlStringRule(String startSequence, String endSequence, IToken token) {
