...
public class YamlQuickOutlineDialog extends AbstractFilterableTreeQuickDialog<Item> {
	...
	public YamlQuickOutlineDialog(IAdaptable adaptable, Shell parent, String infoText) {
		super(adaptable, parent, "Yaml quick outline", MIN_WIDTH, MIN_HEIGHT, infoText);
		this.editor = adaptable.getAdapter(YamlEditor.class);
	}
	...
	protected void openSelectionImpl(ISelection selection, String filterText) {
		...
		YamlEditorContentOutlinePage outlinePage = editor.getOutlinePage();
